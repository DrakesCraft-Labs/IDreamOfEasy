                ...
                switch (e.getCause()) {
                    ...
                    case FIRE:
                        ...
                        if (random.nextDouble() < 0.2) {
                            ...
                            sendMessage(p, this.getItemName() + ": §r§a+Protección contra el fuego");
                        }
                        break;
                        ...
                        if (e instanceof EntityDamageByEntityEvent damage) {
                            ...
                            if (!(damager instanceof Player)) {
                                ...
                                if (random.nextDouble() < 0.2) {
                                    ...
                                    sendMessage(p, this.getItemName() + ": §r§a+Fuerza III");
                                }
                                ...
                                if (random.nextDouble() < 0.3) {
                                    ...
                                    sendMessage(p, this.getItemName() + ": §r§a+Regeneración");
                                }
                                break;
                            }
                        }
