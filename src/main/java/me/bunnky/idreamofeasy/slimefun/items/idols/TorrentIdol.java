                ...
                switch (e.getCause()) {
                    case DROWNING:
                        ...
                        if (random.nextDouble() < 0.2) {
                            ...
                            sendMessage(p, this.getItemName() + ": §r§a+Respiración acuática");
                        }
                        break;
                    ...
                    case FALL:
                        ...
                        if (random.nextDouble() < 0.75) {
                            e.setCancelled(true);
                            sendMessage(p, this.getItemName() + ": §r§a¡Inmune al daño por caída!");
                        }
                        break;
            ...
            if (e.isSprinting()) {
                if (!p.hasPotionEffect(PotionEffectType.SPEED)) {
                    if (random.nextDouble() < 0.6) {
                        ...
                        sendMessage(p, this.getItemName() + ": §r§a+Velocidad II");
                    }
                }
            }
        }
